...
namespace Sellbox.EventListeners
{
    public static class PlayerEvent
    {
            ...
            byte to_rot, byte to_page, ItemData itemData, ref bool shouldAllow)
        {
            ...
            try
            {
                ...
                shouldAllow = !SellboxUtil.IsBlacklisted(player, itemData.item.id);
            }
            catch (Exception e)
            {
            ...
            byte x_1, byte y_1, byte rot_1, ref bool shouldAllow)
        {
            ...
            try
            {
                ...
                shouldAllow = !SellboxUtil.IsBlacklisted(player, itemJar.item.id);
            }
            catch (Exception e)
            {
